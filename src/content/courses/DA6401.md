...
| 3A       | Introduction to Convolutional Neural Networks              | [Slides](https://drive.google.com/file/d/1U_FIiIccyUJD9JZxVGPbqShsVJUxsc_y/view?usp=sharing)                                                                                                                                                                                                      |                      |
...
| :----------------------------------------------------------------------------------------------------- | :---------------------------------------------- | :------------------------------------------------------------------------------------- | :-------------------- | :-------------------- |
| [**Assignment 1**](https://drive.google.com/file/d/1lt2_9Fw3CTpUiUHJ0jckWc8YpmrsB3Hp/view?usp=sharing) | Multi-Layer Perceptron for Image Classification | Implement a MLP and backpropagation from scratch using Numpy to classify MNIST digits. | Feb 09, 2026 10:00 AM | Mar 01, 2026 11:59 PM |
